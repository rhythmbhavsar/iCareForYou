        ...
        <div class="col-xl-10">
            ...
            <div class="card shadow-lg ">
                <div class="row p-2 mt-3 justify-content-between mx-sm-2">
                    ...
                    <div class="col-auto">
                        <a href="product.html"><img class="irc_mi img-fluid bell" src="https://i.imgur.com/uSHMClk.jpg" width="30" height="30"></a>
                    </div>
                </div>
                                ...
                                <div class="row  justify-content-between">
                                    <div class="col-auto col-md-7">
                                        <div class="media flex-column flex-sm-row">
                                            <img class=" img-fluid" src="https://source.unsplash.com/random/300×300" width="62" height="62">
                        ...
                        <div class="card border-0">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-md-5">
                                    <div class="col"><br>
                                        <button type="button" name="" id="" class="btn  btn-primary btn-block ">PURCHASE $37 SEK</button>
                                    </div>
                                </div>    
                            </div>
                        </div>
