...
<body>
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            ...
            <span class="d-none d-md-block dropdown-toggle ps-2">{{Session::get('AdminLoginId')['email']}}</span>
          </a><!-- End Profile Iamge Icon -->

          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            <li class="dropdown-header">
              <h6>{{Session::get('AdminLoginId')['email']}}</h6>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="/adminindex">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="/add_category">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="/add_product">
          <i class="bi bi-card-list"></i>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="/add_pin">
          <i class="bi bi-card-list"></i>
          <span>Add Pincodes</span>
        </a>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="/teammember">
          <i class="bi bi-person"></i>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="/lab_user">
          <i class="bi bi-person"></i>
